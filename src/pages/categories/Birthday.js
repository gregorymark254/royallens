      ...
      <div className="container mx-auto p-4">
        <div className="grid lg:grid-cols-3 gap-6">
          <div className="zoom shadow-lg rounded-lg relative overflow-hidden bg-no-repeat bg-cover"
            ...
            <img src="https://royalens.netlify.app/images/birthday1.jpg"
          ...
          <div className="zoom shadow-lg rounded-lg relative overflow-hidden bg-no-repeat bg-cover"
            data-mdb-ripple="true" data-mdb-ripple-color="dark">
            <img src="https://royalens.netlify.app/images/birthday2.jpg"
              className="w-full transition duration-300 ease-linear align-middle" alt="" />
            <div>
              <div className="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed"
                >
          ...
          <div className="zoom shadow-lg rounded-lg relative overflow-hidden bg-no-repeat bg-cover"
            data-mdb-ripple="true" data-mdb-ripple-color="dark">
            <img src="https://royalens.netlify.app/images/birthday3.jpg"
              className="w-full transition duration-300 ease-linear align-middle" alt="" />
            <div>
              <div className="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed"
                >
          ...
          <div className="zoom shadow-lg rounded-lg relative overflow-hidden bg-no-repeat bg-cover"
            data-mdb-ripple="true" data-mdb-ripple-color="dark">
            <img src="https://royalens.netlify.app/images/birthday4.JPG"
              className="w-full transition duration-300 ease-linear align-middle" alt="" />
            <div>
              <div className="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed"
                >
          ...
          <div className="zoom shadow-lg rounded-lg relative overflow-hidden bg-no-repeat bg-cover"
            data-mdb-ripple="true" data-mdb-ripple-color="dark">
            <img src="https://royalens.netlify.app/images/birthday7.JPG"
              className="w-full transition duration-300 ease-linear align-middle" alt="" />
            <div>
              <div className="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed"
                >
          ...
          <div className="zoom shadow-lg rounded-lg relative overflow-hidden bg-no-repeat bg-cover"
            data-mdb-ripple="true" data-mdb-ripple-color="dark">
            <img src="https://royalens.netlify.app/images/birthday9.JPG"
              className="w-full transition duration-300 ease-linear align-middle" alt="" />
            <div>
              <div className="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed"
                >
