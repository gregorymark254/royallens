        ...
        <div className="container mx-auto p-4">
          <nav className='flex justify-between items-center px-4'>
            ...
            <ul className='hidden md:flex'>
              <li>
                <Link to="/" className="px-3 py-2 hover:text-orange-400">Home</Link>
              </li>
              <li>
                <Link to="/about" className=" px-3 py-2 hover:text-orange-400">About Us</Link>
              </li>
              <li>
                <Link to="/gallary" className=" px-3 py-2 hover:text-orange-400">Gallery</Link>
              </li>
              <li>
                <Link to="/contact" className="px-3 py-2 hover:text-orange-400">Contact Us</Link>
              </li>
            </ul>
